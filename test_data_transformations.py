...
if __name__ == "__main__":
    ...
    data_transformation_simple_tests = DataTransformationsSimpleTest()
    data_transformation_simple_tests.execute_transform_FixValue_FixValue()



    data_transformations_tests_with_external_dataset = DataTransformationsExternalDatasetTests()
    data_transformations_tests_with_external_dataset.execute_transform_FixValue_FixValue_ExternalDatasetTests()
