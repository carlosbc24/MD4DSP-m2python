...
def generateWorkflow():
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByMostFrequent_sex_IRISCHOOL_ETHNICITY__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_input_dataDictionary.csv')
	...
	imputeMissingByMostFrequent_sex_IRISCHOOL_ETHNICITY__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByFixValue_ACADEMIC_INTEREST_2_ACADEMIC_INTEREST_1__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	imputeMissingByFixValue_ACADEMIC_INTEREST_2_ACADEMIC_INTEREST_1__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByMean_avg_income_distance__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	imputeMissingByMean_avg_income_distance__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByLinearInterpolation_satscore__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	imputeMissingByLinearInterpolation_satscore__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	rowFilterRange_init_span__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/missing_output_dataDictionary.csv')
	...
	rowFilterRange_init_span__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/rowFilter_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	columnFilter_TRAVEL_INIT_CNTCTS_REFERRAL_CNCTS_telecq_interest_stuemail_CONTACT_CODE1__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/rowFilter_output_dataDictionary.csv')
	...
	columnFilter_TRAVEL_INIT_CNTCTS_REFERRAL_CNCTS_telecq_interest_stuemail_CONTACT_CODE1__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/columnFilter_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	mapping_TERRITORY__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/columnFilter_output_dataDictionary.csv')
	...
	mapping_TERRITORY__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/ruleEngine_territory_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	mapping_Instate__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/ruleEngine_territory_output_dataDictionary.csv')
	...
	mapping_Instate__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/ruleEngine_instate_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	stringToNumber_TERRITORY_Instate__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/ruleEngine_instate_output_dataDictionary.csv')
	...
	stringToNumber_TERRITORY_Instate__output_dataDictionary_df=pd.read_csv(
	...
	#-----------------New DataProcessing-----------------
	imputeOutlierByClosest_avg_income_distance_Instate__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/stringToNumber_output_dataDictionary.csv')
	...
	imputeOutlierByClosest_avg_income_distance_Instate__output_dataDictionary_df=pd.read_csv(
	...
	#-----------------New DataProcessing-----------------
	binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericOutliers_output_dataDictionary.csv')
	...
	binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__input_dataDictionary_transformed=data_transformations.transform_derived_field(data_dictionary=binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__input_dataDictionary_transformed,
																  data_type_output = DataType(0),
	...
	#-----------------New DataProcessing-----------------
	binner_TERRITORY__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	...
	binner_TERRITORY__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	binner_satscore__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	...
	binner_satscore__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	binner_avg_income__input_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
	...
	binner_avg_income__output_dataDictionary_df=pd.read_csv(
		'./knime_dataDictionaries/numericBinner_output_dataDictionary.csv')
