...
def generateWorkflow():
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByFixValue_ACADEMIC_INTEREST_2_ACADEMIC_INTEREST_1__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByMean_avg_income_distance__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByLinearInterpolation_satscore__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	binner_TERRITORY__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	binner_satscore__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	binner_avg_income__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv')
	...
	if contract_invariants.check_inv_interval_fix_value(data_dictionary_in=binner_avg_income__input_dataDictionary_df,
											...
											data_type_output=DataType(0),
											field_in='avg_income', field_out='avg_income_binned', origin_function="Numeric Binner"):
		print('INVARIANT Numeric Binner(avg_income) Interval:[55559.0, 100000.0) FixValue:High VALIDATED')
	else:
		print('INVARIANT Numeric Binner(avg_income) Interval:[55559.0, 100000.0) FixValue:High NOT VALIDATED')
