...
def generateWorkflow():
	#-----------------New DataProcessing-----------------
	binner_Life_expectancy__input_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_input_dataDictionary.csv')
	if os.path.exists('./knime_dataDictionaries/binner_output_dataDictionary.csv'):
		binner_Life_expectancy__output_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	rowFilterPrimitive_Region__input_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_output_dataDictionary.csv')

	if os.path.exists('./knime_dataDictionaries/rowFilterPrimitive_output_dataDictionary.csv'):
		rowFilterPrimitive_Region__output_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/rowFilterPrimitive_output_dataDictionary.csv')
