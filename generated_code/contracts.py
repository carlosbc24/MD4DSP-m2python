...
class DataProcessing:
    def generateDataProcessing(self):
        ...
        if pre_post.check_missing_range(belong_op=Belong(0), data_dictionary=imputeByDerivedValue_input_dataDictionary,
                                        field='sex',
        ...
        if pre_post.check_missing_range(belong_op=Belong(1), data_dictionary=imputeByDerivedValue_output_dataDictionary,
                                        field='sex',
        ...
        if invariants.check_inv_special_value_derived_value(
        ...
        if pre_post.check_missing_range(belong_op=Belong(0), data_dictionary=imputeByFixValue_input_dataDictionary,
        ...
        if pre_post.check_missing_range(belong_op=Belong(1), data_dictionary=imputeByFixValue_output_dataDictionary,
                                        field='ACADEMIC_INTEREST_2',
        ...
        if pre_post.check_missing_range(belong_op=Belong(0), data_dictionary=imputeByNumericOp_input_dataDictionary,
                                        field='avg_income',
        ...
        if pre_post.check_missing_range(belong_op=Belong(1), data_dictionary=imputeByNumericOp_output_dataDictionary,
                                        field='avg_income',
        ...
        if pre_post.check_fix_value_range(value=0, data_dictionary=rowFilter_input_DataDictionary, belong_op=Belong(0),
                                          field='init_span',
                                          quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_fix_value_range(value='0', data_dictionary=rowFilter_output_DataDictionary,
        ...
        if pre_post.check_fix_value_range(value='A', data_dictionary=mapping_input_dataDictionary, belong_op=Belong(0),
                                          field='TERRITORY',
                                          quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_fix_value_range(value='N', data_dictionary=mapping_input_dataDictionary, belong_op=Belong(0),
                                          field='TERRITORY',
                                          quant_abs=None, quant_rel=None, quant_op=None):
            print('PRECONDITION mapping(TERRITORY)_PRE_valueRange VALIDATED')
        else:
        ...
        if pre_post.check_fix_value_range(value='A', data_dictionary=mapping_output_dataDictionary, belong_op=Belong(0),
                                          field='TERRITORY',
                                          quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_fix_value_range(value='N', data_dictionary=mapping_output_dataDictionary, belong_op=Belong(0),
                                          field='TERRITORY',
                                          quant_abs=None, quant_rel=None, quant_op=None):
            print('POSTCONDITION mapping(TERRITORY)_POST_valueRange VALIDATED')
        else:
        ...
        if pre_post.check_fix_value_range(value='Y', data_dictionary=mapping_input_dataDictionary, belong_op=Belong(0),
                                          field='Instate',
                                          quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_fix_value_range(value='Y', data_dictionary=mapping_output_dataDictionary, belong_op=Belong(0),
                                          field='Instate',
                                          quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if invariants.check_inv_missing_value_missing_value(
        ...
        if pre_post.check_outliers(belong_op=Belong(0), data_dictionary=imputeByNumericOp_input_dataDictionary,
                                   field='avg_income',
                                   quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_outliers(belong_op=Belong(1), data_dictionary=imputeByNumericOp_output_dataDictionary,
                                   field='avg_income',
                                   quant_abs=None, quant_rel=None, quant_op=None):
        ...
        if pre_post.check_interval_range_float(left_margin=-1000.0, right_margin=1.0,
        ...
        if pre_post.check_interval_range_float(left_margin=0.0, right_margin=1000.0,
                                               data_dictionary=binner_input_dataDictionary,
        ...
        if pre_post.check_interval_range_float(left_margin=-1000.0, right_margin=2000.0,
                                               data_dictionary=binner_input_dataDictionary,
        ...
        if pre_post.check_interval_range_float(left_margin=9.0, right_margin=100000.0,
                                               data_dictionary=binner_input_dataDictionary,
