...
def generateWorkflow():
	#-----------------New DataProcessing-----------------
	binner_hours_per_week__input_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_input_dataDictionary.csv')
	if os.path.exists('./knime_dataDictionaries/binner_output_dataDictionary.csv'):
		binner_hours_per_week__output_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	mapping_native_country__input_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/binner_output_dataDictionary.csv')

	if os.path.exists('./knime_dataDictionaries/mapping_output_dataDictionary.csv'):
		mapping_native_country__output_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/mapping_output_dataDictionary.csv')
	...
	#-----------------New DataProcessing-----------------
	mathOperation_Age_of_birth__input_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/mapping_output_dataDictionary.csv')

	if os.path.exists('./knime_dataDictionaries/mathOperation_output_dataDictionary.csv'):
		mathOperation_Age_of_birth__output_dataDictionary_df=pd.read_csv('./knime_dataDictionaries/mathOperation_output_dataDictionary.csv')
