...
def generateDataProcessing():
    ...
    imputeByDerivedValue_input_dataDictionary = pd.read_csv('./knime_dataDictionaries/missing_input_dataDictionary.csv',
                                                            sep=',')
    if os.path.exists(
            './knime_dataDictionaries/missing_output_dataDictionary.csv'):  #If the output DataDictionary exists, we store it
        imputeByDerivedValue_output_dataDictionary = pd.read_csv(
            './knime_dataDictionaries/missing_output_dataDictionary.csv', sep=',')
    ...
    if os.path.exists(
        ...
        rowFilterRange_output_DataDictionary = pd.read_csv(
