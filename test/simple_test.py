...
class ContractTest:
    ...
    def execute_CheckFieldRange_Tests(self):
        print("Testing CheckFieldRange Function")
        print()

        print("Casos Básicos solitados en la especificación del contrato:")
        ...
        print("Test Case 1 Passed: Expected True, got True")
        ...
        print("Test Case 2 Passed: Expected False, got False")
        ...
        print("Test Case 3 Passed: Expected True, got True")

        print()
        print("Casos Básicos añadidos:")
        ...
        print("Test Case 4 Passed: Expected False, got False")
        ...
        print("Test Case 5 Passed: Expected True, got True")
        print()

    def execute_CheckFixValueRangeString_Tests(self):
        print("Testing CheckFixValueRangeString Function")
        ...
        print("Test Case 13 Passed: Expected True, got True")
        ...
        print("Test Case 14 Passed: Expected False, got False")
        ...
        print("Test Case 18 Passed: Expected True, got True")

        # --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

        print()
        print("Casos añadidos:")
        ...
        print("Test Case 6 Passed: Expected False, got False")
        ...
        print("Test Case 8 Passed: Expected True, got True")
        ...
        print("Test Case 9 Passed: Expected False, got False")
        ...
        print("Test Case 11 Passed: Expected True, got True")
        ...
        print("Test Case 12 Passed: Expected False, got False")
        ...
        print("Test Case 15 Passed: Expected True, got True")
        ...
        print("Test Case 16 Passed: Expected False, got False")
        ...
        print("Test Case 19 Passed: Expected False, got False")

#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

        # Casos de error añadidos
        #print()
        #print("Casos de error añadidos:")
        ...
        #print("Test Case 4.5 Passed: Expected ValueError, got ValueError")
        ...
        #print("Test Case 7 Passed: Expected ValueError, got ValueError")
        ...
        # print("Test Case 10 Passed: Expected ValueError, got ValueError")
        ...
        #print("Test Case 14.5 Passed: Expected ValueError, got ValueError")
        ...
        #print("Test Case 17 Passed: Expected ValueError, got ValueError")
        ...
        #print("Test Case 20 Passed: Expected ValueError, got ValueError")
