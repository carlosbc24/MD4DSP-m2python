...
class DataTransformations:
    ...
    def transform_filter_columns(self, data_dictionary: pd.DataFrame, columns: list[str],
    ...
    def transform_cast_type(self, data_dictionary: pd.DataFrame, data_type_output: DataType,
