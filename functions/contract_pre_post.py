...
class ContractsPrePost:
    ...
    def check_field_range(self, fields: list, data_dictionary: pd.DataFrame, belong_op: Belong) -> bool:
        """
    ...
    def check_fix_value_range(self, value: Union[str, float, datetime], data_dictionary: pd.DataFrame, belong_op: Belong,
    ...
    def check_interval_range_float(self, left_margin: float, right_margin: float, data_dictionary: pd.DataFrame,
    ...
    def check_invalid_values(self, belong_op: Belong, data_dictionary: pd.DataFrame, invalid_values: list,
                             field: str = None, quant_abs: int = None, quant_rel: float = None,
                             quant_op: Operator = None) -> bool:
        """
    ...
    def check_outliers(self, data_dictionary: pd.DataFrame, belong_op: Belong = None, field: str = None,
