...
class InvariantsSimpleTest(unittest.TestCase):
    ...
    def execute_checkInv_FixValue_FixValue(self):
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(2), fixValueInput=2,
                                                               dataTypeOutput=DataType(2),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(0), field=None)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Clara',
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(1),
                                                               fixValueInput=pd.to_datetime('2021-01-01'),
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, fixValueInput=3.0,
                                                            fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(0), field=None)
        # Verificar si el resultado obtenido coincide con el esperado
        ...
        expected_df = pd.DataFrame({'A': [0, 1, fixValueOutput, 3, 4], 'B': [5, 4, 3, fixValueOutput, 1]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df,
                                                            dataTypeInput=DataType(2), fixValueInput=2,
                                                            dataTypeOutput=DataType(2),
                                                            fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(1),
                                                            field=None)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df,
                                                            dataTypeInput=DataType(0), fixValueInput='Clara',
                                                            dataTypeOutput=DataType(3),
                                                            fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(1),
                                                            field=None)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df,
                                                            ...
                                                            fixValueInput=pd.to_datetime('2021-01-01'),
                                                            dataTypeOutput=DataType(4),
                                                            fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(1), field=None)
        # Verificar si el resultado obtenido coincide con el esperado
        ...
        field='A'
        # Definir el resultado esperado
        expected_df = pd.DataFrame({'A': [fixValueOutput, 'Ana', fixValueOutput, fixValueOutput, fixValueOutput], 'B': ['Clara', 'Clara', 'Ana', fixValueOutput, 'Ana']})

        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Clara',
                                                               dataTypeOutput=DataType(3),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(0), field=field)
        ...
        field='A'
        # Definir el resultado esperado
        expected_df = pd.DataFrame({'A': [fixValueOutput, 'Ana', fixValueOutput, 'Clara', 'Clara'], 'B': ['Clara', 'Clara', 'Ana', fixValueOutput, 'Ana']})

        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Clara',
                                                               dataTypeOutput=DataType(3),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(0), belongOp_out=Belong(1), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Clara',
                                                               dataTypeOutput=DataType(3),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(1), belongOp_out=Belong(0), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Carlos',
                                                               dataTypeOutput=DataType(3),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(1), belongOp_out=Belong(0), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(dataDictionary_in=df, dataDictionary_out=expected_df, dataTypeInput=DataType(0), fixValueInput='Clara',
                                                               dataTypeOutput=DataType(3),
                                                               fixValueOutput=fixValueOutput, belongOp_in=Belong(1), belongOp_out=Belong(1), field=None)
    ...
    def execute_checkInv_FixValue_DerivedValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_DerivedValue(dataDictionary_in=datadic.copy(), dataTypeInput=DataType(2),
                                                                fixValueInput=0,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_DerivedValue(dataDictionary_in=datadic.copy(), dataTypeInput=DataType(0),
    ...
    def execute_checkInv_Interval_FixValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_FixValue(dataDictionary_in=datadic.copy(), leftMargin=0, rightMargin=5,
                                                            closureType=Closure(0), dataTypeOutput=DataType(0),
                                                            fixValueOutput='Suspenso', belongOp_in=Belong(0),
        ...
        result = self.invariants.checkInv_Interval_FixValue(dataDictionary_in=datadic.copy(), leftMargin=0, rightMargin=5,
                                                            closureType=Closure(0), dataTypeOutput=DataType(0),
                                                            fixValueOutput='Suspenso', field=field, belongOp_in=Belong(0),
                                                            belongOp_out=Belong(0), dataDictionary_out=expected)
        ...
        result = self.invariants.checkInv_Interval_FixValue(dataDictionary_in=datadic.copy(), leftMargin=0, rightMargin=5,
                                                            closureType=Closure(3), dataTypeOutput=DataType(0),
                                                            fixValueOutput='Suspe', field=field,
                                                            belongOp_in=Belong(0), belongOp_out=Belong(0),
                                                            dataDictionary_out=expected)
        ...
        # Aplicar la transformación de datos
        field = 'A'
        result = self.invariants.checkInv_Interval_FixValue(dataDictionary_in=datadic.copy(), leftMargin=7, rightMargin=8,
                                                            closureType=Closure(3), dataTypeOutput=DataType(0),
                                                            fixValueOutput='Notable', field=field,
        ...
        # Aplicar la transformación de datos
        field = 'A'
        result = self.invariants.checkInv_Interval_FixValue(dataDictionary_in=datadic.copy(), leftMargin=0,
                                                            rightMargin=5,
                                                            closureType=Closure(3), dataTypeOutput=DataType(0),
                                                            fixValueOutput='Notable', field=None,
    ...
    def execute_checkInv_SpecialValue_FixValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(dataDictionary_in=datadic.copy(), dataDictionary_out=expected, specialTypeInput=SpecialType(0),
                                                                dataTypeOutput=DataType(2), belongOp_in=Belong(0), belongOp_out=Belong(0),
                                                                fixValueOutput=999, missing_values=missing_values, axis_param=0, field=None)
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(dataDictionary_in=datadic.copy(), dataDictionary_out=expected,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(dataDictionary_in=datadic.copy(), dataDictionary_out=expected,
                                                                specialTypeInput=SpecialType(2), dataTypeOutput=DataType(2),
                                                                belongOp_in=Belong(0), belongOp_out=Belong(0), fixValueOutput=999,
        ...
        result = self.invariants.checkInv_SpecialValue_FixValue(dataDictionary_in=datadic.copy(), dataDictionary_out=expected, specialTypeInput=SpecialType(2),
                                                                dataTypeOutput=DataType(2), belongOp_in=Belong(0), belongOp_out=Belong(0), fixValueOutput=999,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(dataDictionary_in=datadic.copy(), dataDictionary_out=expected, specialTypeInput=SpecialType(1),
                                                                dataTypeOutput=DataType(2), belongOp_in=Belong(0), belongOp_out=Belong(0), fixValueOutput=999,
                                                                missing_values=missing_values, axis_param=0,
                                                                field=field)
    ...
    def execute_checkInv_SpecialValue_NumOp(self):
        ...
        expected_df = pd.DataFrame(
            {'A': [0, 2, 2, 2.0, 2], 'B': [2, 2 + 4.0 / 3, 2 + 8.0 / 3, 6, 12], 'C': [10, 7.5, 5, 2.5, 0],
             'D': [8.2, 8.2, 6, 4, 2]})
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(0), numOpOutput=Operation(0),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
                                                             missing_values=missing_values, axis_param=0, field=None)
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(0), numOpOutput=Operation(1),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(0), numOpOutput=Operation(2),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        with self.assertRaises(expected_exception) as context:
            result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                                 specialTypeInput=SpecialType(0), numOpOutput=Operation(3),
                                                                 belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(1), numOpOutput=Operation(0),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(1), numOpOutput=Operation(1),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(1), numOpOutput=Operation(2),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(1), numOpOutput=Operation(3),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
                                                             missing_values=missing_values, axis_param=0, field=None)
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(2), numOpOutput=Operation(0),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(2), numOpOutput=Operation(1),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(2), numOpOutput=Operation(2),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(), dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(2), numOpOutput=Operation(3),
                                                             belongOp_in=Belong(0), belongOp_out=Belong(0),
                                                             missing_values=None, axis_param=0, field=None)
        ...
        expected_df = pd.DataFrame(
            {'A': [0, 2, 2, 3, 0], 'B': [2, 2, 3, 6, 12], 'C': [10, 3, 4, np.NaN, 0], 'D': [2, 8.2, 2, 2, 2]})
        result = self.invariants.checkInv_SpecialValue_NumOp(dataDictionary_in=datadic.copy(),
                                                             dataDictionary_out=expected_df,
                                                             specialTypeInput=SpecialType(1), numOpOutput=Operation(3),
                                                             belongOp_in=Belong(1), belongOp_out=Belong(1),
                                                             missing_values=missing_values, axis_param=0, field=None)
