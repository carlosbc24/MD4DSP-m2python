...
class InvariantsSimpleTest(unittest.TestCase):
    ...
    execute_checkInv_FixValue_DerivedValue: method to execute the simple tests of the function checkInv_FixValue_DerivedValue
    ...
    execute_checkInv_Interval_DerivedValue: method to execute the simple tests of the function checkInv_Interval_DerivedValue
    execute_checkInv_Interval_NumOp: method to execute the simple tests of the function checkInv_Interval_NumOp
    execute_checkInv_SpecialValue_FixValue: method to execute the simple tests of the function checkInv_SpecialValue_FixValue
    execute_checkInv_SpecialValue_DerivedValue: method to execute the simple tests of the function checkInv_SpecialValue_DerivedValue
    ...
    def execute_checkInv_FixValue_FixValue(self):
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(2), fix_value_input=2,
                                                               data_type_output=DataType(2),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(0), field=None)
        ...
        expected_df = pd.DataFrame({'A': [fix_value_output, 'Ana', fix_value_output, fix_value_output, fix_value_output],
                                    'B': [fix_value_output, fix_value_output, 'Ana', 'Ana', 'Ana']})

        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Clara',
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(1),
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, fix_value_input=3.0,
                                                            fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(0), field=None)
        # Verificar si el resultado obtenido coincide con el esperado
        ...
        expected_df = pd.DataFrame({'A': [0, 1, fix_value_output, 3, 4], 'B': [5, 4, 3, fix_value_output, 1]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df,
                                                            data_type_input=DataType(2), fix_value_input=2,
                                                            data_type_output=DataType(2),
                                                            fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(1),
                                                            field=None)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df,
                                                            ...
                                                            fix_value_input=pd.to_datetime('2021-01-01'),
                                                            data_type_output=DataType(4),
                                                            fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(1), field=None)
        # Verificar si el resultado obtenido coincide con el esperado
        ...
        field='A'
        # Definir el resultado esperado
        expected_df = pd.DataFrame({'A': [fix_value_output, 'Ana', fix_value_output, fix_value_output, fix_value_output], 'B': ['Clara', 'Clara', 'Ana', fix_value_output, 'Ana']})

        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Clara',
                                                               data_type_output=DataType(3),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(0), field=field)
        ...
        field='A'
        # Definir el resultado esperado
        expected_df = pd.DataFrame({'A': [fix_value_output, 'Ana', fix_value_output, 'Clara', 'Clara'], 'B': ['Clara', 'Clara', 'Ana', fix_value_output, 'Ana']})

        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Clara',
                                                               data_type_output=DataType(3),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(0), belong_op_out=Belong(1), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Clara',
                                                               data_type_output=DataType(3),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(1), belong_op_out=Belong(0), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Carlos',
                                                               data_type_output=DataType(3),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(1), belong_op_out=Belong(0), field=field)
        ...
        result = self.invariants.checkInv_FixValue_FixValue(data_dictionary_in=df, data_dictionary_out=expected_df, data_type_input=DataType(0), fix_value_input='Clara',
                                                               data_type_output=DataType(3),
                                                               fix_value_output=fix_value_output, belong_op_in=Belong(1), belong_op_out=Belong(1), field=None)
    ...
    def execute_checkInv_FixValue_DerivedValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_DerivedValue(data_dictionary_in=datadic.copy(), data_type_input=DataType(2),
                                                                fix_value_input=0,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_DerivedValue(data_dictionary_in=datadic.copy(), data_type_input=DataType(0),
        ...
        expected = pd.DataFrame({'A': [2, 2, 3, 5, 5], 'B': [1, 2, 4, 4, 5], 'C': [1, 2, 3, 4, 3]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_DerivedValue(data_dictionary_in=datadic.copy(),
    ...
    def execute_checkInv_FixValue_NumOp(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_FixValue_NumOp(data_dictionary_in=datadic.copy(), data_type_input=DataType(2),
    ...
    def execute_checkInv_Interval_FixValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_FixValue(data_dictionary_in=datadic.copy(), left_margin=0, right_margin=5,
        ...
        result = self.invariants.checkInv_Interval_FixValue(data_dictionary_in=datadic.copy(), left_margin=0, right_margin=5,
                                                            closure_type=Closure(0), data_type_output=DataType(0),
                                                            fix_value_output='Suspenso', field=field, belong_op_in=Belong(0),
                                                            belong_op_out=Belong(0), data_dictionary_out=expected)
        ...
        # Aplicar la transformación de datos
        field = 'A'
        result = self.invariants.checkInv_Interval_FixValue(data_dictionary_in=datadic.copy(), left_margin=7, right_margin=8,
                                                            closure_type=Closure(3), data_type_output=DataType(0),
        ...
        # Aplicar la transformación de datos
        field = 'A'
        result = self.invariants.checkInv_Interval_FixValue(data_dictionary_in=datadic.copy(), left_margin=0,
                                                            right_margin=5,
                                                            closure_type=Closure(3), data_type_output=DataType(0),
    ...
    def execute_checkInv_Interval_DerivedValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_DerivedValue(data_dictionary_in=datadic.copy(), left_margin=0, right_margin=5,
        ...
        expected = pd.DataFrame({'A': [0, 2, 3, 4, 5], 'B': [0, 2, 6, 0, 5], 'C': [0, 2, 3, 4, 5]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_DerivedValue(data_dictionary_in=datadic.copy(), left_margin=0,
                                                                right_margin=5,
                                                                closure_type=Closure(0),
                                                                derived_type_output=DerivedType(0),
                                                                axis_param=1,
        ...
        expected = pd.DataFrame({'A': [2, 2, 2, 2, 5], 'B': [2, 2, 6, 2, 5], 'C': [2, 2, 2, 2, 5]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_DerivedValue(data_dictionary_in=datadic.copy(), left_margin=7,
                                                                right_margin=10,
                                                                closure_type=Closure(2),
                                                                derived_type_output=DerivedType(0),
                                                                axis_param=None,
        ...
        expected = pd.DataFrame({'A': [0, 0, 0, 0, 5], 'B': [2, 3, 6, 0, 5], 'C': [1, 2, 3, 4, 5]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_DerivedValue(data_dictionary_in=datadic.copy(), left_margin=-2,
                                                                right_margin=-1,
                                                                closure_type=Closure(0),
                                                                derived_type_output=DerivedType(0),
                                                                axis_param=1, field=field,
        ...
        expected = pd.DataFrame({'A': [0, 3, 4, 5, 5], 'B': [2, 3, 6, 0, 5], 'C': [1, 2, 3, 4, 5]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_DerivedValue(data_dictionary_in=datadic.copy(), left_margin=10,
                                                                right_margin=50,
                                                                closure_type=Closure(0),
                                                                derived_type_output=DerivedType(2),
                                                                axis_param=1, field=field,
    ...
    def execute_checkInv_Interval_NumOp(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=2, right_margin=4,
        ...
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=3, right_margin=4,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=0, right_margin=3,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=0, right_margin=4,
        ...
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=2, right_margin=4,
                                                         closure_type=Closure(3), num_op_output=Operation(0),
                                                         axis_param=None, field=field, belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                         data_dictionary_out=expected)
        # Verificar si el resultado obtenido coincide con el esperado
        assert result is False, "Test Case 11 Failed: Expected False, but got True"
        print_and_log("Test Case 11 Passed: Expected False, got False")
        ...
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=2, right_margin=4,
                                                         closure_type=Closure(3), num_op_output=Operation(0),
                                                         axis_param=None, field=field, belong_op_in=Belong(0), belong_op_out=Belong(1),
                                                         data_dictionary_out=expected)
        # Verificar si el resultado obtenido coincide con el esperado
        ...
        expected = pd.DataFrame({'A': [0, 2, 2, 3, 5], 'B': [2, 3, 6, 0, 5], 'C': [1, 2, 3, 4, 5]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_Interval_NumOp(data_dictionary_in=datadic.copy(), left_margin=7, right_margin=10,
                                                         closure_type=Closure(3), num_op_output=Operation(3),
                                                         axis_param=None, field=field,
                                                         belong_op_in=Belong(1), belong_op_out=Belong(1),
                                                         data_dictionary_out=expected)
    ...
    def execute_checkInv_SpecialValue_FixValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(), data_dictionary_out=expected, special_type_input=SpecialType(0),
                                                                data_type_output=DataType(2), belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                                fix_value_output=999, missing_values=missing_values, axis_param=0, field=None)
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(), data_dictionary_out=expected,
                                                                special_type_input=SpecialType(1), data_type_output=DataType(2),
                                                                belong_op_in=Belong(0), belong_op_out=Belong(0), fix_value_output=999,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(), data_dictionary_out=expected,
                                                                special_type_input=SpecialType(2), data_type_output=DataType(2),
                                                                belong_op_in=Belong(0), belong_op_out=Belong(0), fix_value_output=999,
        ...
        expected = pd.DataFrame(
            {'A': [0, 2, 3, 4, 1], 'B': [2, 3, 4, 6, 10], 'C': [1, 999, 3, 4, 1], 'D': [2, 3, 4, 6, 10],
             'E': [1, 999, 3, 4, 1]})
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(), data_dictionary_out=expected, special_type_input=SpecialType(2),
                                                                data_type_output=DataType(2), belong_op_in=Belong(0), belong_op_out=Belong(0), fix_value_output=999,
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(), data_dictionary_out=expected, special_type_input=SpecialType(1),
                                                                data_type_output=DataType(2), belong_op_in=Belong(0), belong_op_out=Belong(0), fix_value_output=999,
                                                                missing_values=missing_values, axis_param=0,
                                                                field=field)
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_FixValue(data_dictionary_in=datadic.copy(),
                                                                data_dictionary_out=expected,
    ...
    def execute_checkInv_SpecialValue_DerivedValue(self):
        ...
        # Aplicar la transformación de datos
        result = self.invariants.checkInv_SpecialValue_DerivedValue(data_dictionary_in=datadic.copy(),
                                                                    special_type_input=SpecialType(0),
                                                                    derived_type_output=DerivedType(0),
        ...
        result = self.invariants.checkInv_SpecialValue_DerivedValue(data_dictionary_in=datadic.copy(),
                                                                    ...
                                                                    derived_type_output=DerivedType(0),
                                                                    missing_values=missing_values,
                                                                    axis_param=1, field=field, belong_op_in=Belong(0),
                                                                    belong_op_out=Belong(0), data_dictionary_out=expected)
        ...
        result = self.invariants.checkInv_SpecialValue_DerivedValue(data_dictionary_in=datadic.copy(),
                                                                    ...
                                                                    derived_type_output=DerivedType(0),
                                                                    missing_values=missing_values,
                                                                    field=field, belong_op_in=Belong(0),
                                                                    belong_op_out=Belong(0), data_dictionary_out=expected)
    ...
    def execute_checkInv_SpecialValue_NumOp(self):
        ...
        expected_df = pd.DataFrame(
            {'A': [0, 2, 2, 2.0, 2], 'B': [2, 2 + 4.0 / 3, 2 + 8.0 / 3, 6, 12], 'C': [10, 7.5, 5, 2.5, 0],
             'D': [8.2, 8.2, 6, 4, 2]})
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(0), num_op_output=Operation(2),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
        ...
        with self.assertRaises(expected_exception) as context:
            result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                                 special_type_input=SpecialType(0), num_op_output=Operation(3),
                                                                 belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                                 missing_values=missing_values, axis_param=0, field='C')
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(0), num_op_output=Operation(3),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                             missing_values=missing_values, axis_param=0, field='A')
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(1), num_op_output=Operation(0),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                             missing_values=missing_values, axis_param=0, field='D')
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(1), num_op_output=Operation(1),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(1), num_op_output=Operation(2),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                             missing_values=missing_values, axis_param=1, field=None)
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(1), num_op_output=Operation(3),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                             missing_values=missing_values, axis_param=0, field=None)
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(2), num_op_output=Operation(0),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
        ...
        expected_df = pd.DataFrame(
            {'A': [0, 2, 3, 4, 1], 'B': [2, 3, 4, 6, datadic.mean().mean()], 'C': [3.7, 1, 3, 3, 0], 'D': [1, 8.2, 6, 1, 2]})

        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(2), num_op_output=Operation(1),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
                                                             missing_values=None, axis_param=None, field=None)
        ...
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(), data_dictionary_out=expected_df,
                                                             special_type_input=SpecialType(2), num_op_output=Operation(2),
                                                             belong_op_in=Belong(0), belong_op_out=Belong(0),
        ...
        expected_df = pd.DataFrame(
            {'A': [0, 2, 2, 3, 0], 'B': [2, 2, 3, 6, 12], 'C': [10, 3, 4, np.NaN, 0], 'D': [2, 8.2, 2, 2, 2]})
        result = self.invariants.checkInv_SpecialValue_NumOp(data_dictionary_in=datadic.copy(),
